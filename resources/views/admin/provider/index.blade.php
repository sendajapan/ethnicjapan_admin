...
@section('content')
    <section class="content-main">
        <div class="content-header">
            <div>
                <h4 class="content-title card-title">Providers</h4>
            </div>
        </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="{{ route('admin.provider.create') }}" class="btn btn-sm btn-outline-dark text-sm mb-4"><i class="fas fa-plus"></i>New Provider</a>
                        </div>
