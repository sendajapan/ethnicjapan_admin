...
@section('content')
    <section class="content-main">
        <div class="content-header">
            <div>
                <h4 class="content-title card-title">Purchase Data Report</h4>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <table class="table table-striped table-hover" id="table_{{$year}}_01">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-end" scope="col" data-sortable="true">Total Purchases</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @php
                                    ...
                                    <div class="col-3 offset-1">
                                                ...
                                                <table class="table table-striped table-hover" id="table_{{$year}}_03">
                                                    ...
                                                    @php
                                                        $total_amount = 0;
                                                    @endphp
                                                    @foreach($yearly_data['by_provider'] as $provider => $line_total)
                                                        <tr>
                                                            <td>{{$provider}}</td>
                                                            <td class="text-end">$ {{ number_format($line_total) }}</td>
                                                        </tr>
