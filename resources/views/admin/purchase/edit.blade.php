                                ...
                                <tbody>
                                    ...
                                    @forelse($costs as $index => $cost)
                                        <tr>
                                            ...
                                            <td width="10%"><input type="number" class="form-control exchange-rate-field" name="costs[{{ $index }}][exchange_rate]" value="{{ $cost['exchange_rate'] ?? '' }}" readonly></td>
                                            <td width="40%"><input type="text" class="form-control" name="costs[{{ $index }}][description]" value="{{ $cost['description'] ?? '' }}"></td>
