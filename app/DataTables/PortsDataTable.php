...
class PortsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                return '<a href="'. route('admin.ports.edit', $query->id) .'" class="btn btn-sm font-sm rounded btn-dark">
                    <i class="material-icons md-edit fs-6"></i>
                </a>
                <a href="'. route('admin.ports.destroy', $query->id) .'" class="btn btn-sm delete-part-category font-sm rounded btn-danger">
        ...
        return $this->builder()
            ...
            ->buttons([
                Button::make('create')
                    ...
                    ->action("window.location = '".route('admin.ports.create')."';")
                    ->text('<i class="fas fa-plus"></i> Create New Port'),
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('port_name')->className('text-start')->width(140),
            Column::make('country_name')->className('text-start')->width(140),
