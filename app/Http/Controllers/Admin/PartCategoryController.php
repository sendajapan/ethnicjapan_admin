...
class PartCategoryController extends Controller
{
    ...
    {
        $data = PartCategory::orderBy('name')->get();
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $partCategory->description = $request->input('description');
            $partCategory->quantity = $request->input('default_quantity');
            $partCategory->price = $request->input('default_price');
            $partCategory->is_generic = $request->input('generic');
            ...
            DB::rollBack();
            return redirect()->back()->with('error', 'error inserting ' . $partCategory->name . ': ' . $exception->getMessage());
        }

        return redirect()->route('admin.part-category.index')->with('success', $partCategory->name . ' inserted successfully.');
    }
